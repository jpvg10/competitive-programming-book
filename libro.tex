...
\section{Teoría de números}
	...
	\lstinputlisting[firstline=7, lastline=23]{./src/Sieve.java}
	...
	\lstinputlisting[firstline=25, lastline=42]{./src/Sieve.java}	
	
	\subsection{Cantidad de divisores de un número}
	Este método utiliza la factorización prima descrita en la sección anterior para hallar la cantidad de divisores que tiene un número. No lista los divisores, sólo dice cuántos son.
	\lstinputlisting[firstline=44, lastline=54]{./src/Sieve.java}
