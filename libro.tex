...
\]
Sin embargo no es muy práctico usar esta fórmula ya que involucra factoriales. Se aprovecha el hecho de que \( \binom{n}{k} = \binom{n-1}{k-1} + \binom{n-1}{k-1} \) para generar todos los coeficientes desde \( k = 0 \) hasta \( k = n \).
