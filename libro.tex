...
\section{Teoría de números}
	...
	\lstinputlisting[firstline=27, lastline=48]{./src/Sieve.java}
	
	\subsection{Fórmulas de divisores}
	Es posible calcular la cantidad de divisores de un número \( n \) y la suma de ellos, partiendo de la factorización prima de \( n \):
	\[ n = \prod p_{i}^{a_{i}} = p_{1}^{a_{1}} \cdot p_{2}^{a_{2}} \cdot p_{3}^{a_{3}} ... \]
...
\section{Complete search}
	...
	\lstinputlisting[firstline=5, lastline=34]{./src/Combinations.java}
